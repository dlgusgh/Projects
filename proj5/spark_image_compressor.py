...
def do_sub_blocks(image):
    ...
    for y in range(0,index_y):
        for x in range(0,index_x):
            rt += [((image[0][0],image[0][1]),(dimen[0],dimen[1],y*8,x*8,image[1][y*8: y*8+8, x*8:x*8+8]))]
    return rt
...
def combs_1(part1,part2):
    if (part1[5]):
        ...
        rt_matrix[part1[2]:part1[2]+8,part1[3]:part1[3]+8]=part1[4]
    else:
        rt_matrix = part1[4]
    rt_matrix[part2[2]:part2[2]+8,part2[3]:part2[3]+8]=part2[4]
