...
strlen:
	# YOUR CODE HERE
	addu $t0,$0,$0    #t0 counter
	Loop1:
		lbu $t1,0 ($a0)		
		beq $t1,$0,end1		#if end of string, end
		addi $t0,$t0,1		#increase counter of strlen
		addi $a0,$a0,1		#move to next char in string
		j Loop1
	end1:
	addu $v0,$t0,$0
	jr $ra
...
strncpy:
	# YOUR CODE HERE
	addu $v0,$a0,$0			#load destination array before a0 gets clobbered 
	Loop2:
		beq $a2,$0,End2		#if end of string or empty string, end
		lbu $t0,0($a1)		#copy first char to destination array
		sb $t0, 0($a0)
		addiu $a0,$a0,1		#move to next char
		addiu $a1,$a1,1
		addiu $a2, $a2, -1	#increase counter by 1
		j Loop2
	End2:
	sb $0, 0($a0)
	addiu $t0,$t0,1
...
copy_of_str:
	...
	sw $ra, 0($sp)
	sw $a0, 4($sp)
	jal strlen			#get string len
	addu $a0,$0,$v0		#allocate space for string
	addiu $v0,$0,9
	syscall
	addu $a2,$a0,$0		#copy string 
	addu $a0,$v0,$0
	lw $a1,4($sp)
	jal strncpy
	lw $a0, 4($sp)
